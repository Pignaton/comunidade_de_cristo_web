...
<div class="container-body">
    <div class=" container-card shadow-soft border-light">
        <div class=" container-image">
            <img src="{{asset('assets')}}/images/simbolo_roxo.png" class="linktree">
        </div>
        ...
        <div class="container" style='margin-top: -5rem;'>
            <div class="col-xs-12">
                <div class="text-center" style="padding-top: 30px; padding-bottom: 30px;">
                    <h2 style="color: #000; padding-top: 20px;">Igreja Batista Comunidade de Cristo</h2>
                </div>
            </div>
            <div class="social">
                ...
                <a href="https://www.facebook.com/comunidade.cristo/?locale=pt_BR" target="_blank"
                ...
                <div class="text-center">
                    <div style="padding-bottom: 30px;">
                        <button onclick="location.href='{{route('linktree.agenda')}}'" type="button"
                                ...
                                style="width: 90%; padding-top:10px; padding-bottom:10px; font-weight: 600;">Confira
                            nossa
                    ...
                    <div style="padding-bottom: 30px;">
                        <button onclick="location.href='#'" type="button" class="btn btn-outline-dark"
                                style="width: 90%; padding-top:10px; padding-bottom:10px; font-weight: 600;">Inscrição
                            MMR
                        </button>
                    </div>
                </div>
    ...
    <div class="text-center pt-3">
        <a href="https://kalweb.com.br/" style="color: #34312f;" target="_blank">Desenvolvido por Igreja Batista
            Comunidade
            de Cristo</a>
    </div>
</div>
